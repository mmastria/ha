...
diff -q ~/ha/setup_indi/indidome.cpp.ORIGINAL ~/indi/libindi/libs/indibase/indidome.cpp.ORIGINAL || exit 1 
diff -q ~/ha/setup_indi/dome_script.cpp.ORIGINAL ~/indi/libindi/drivers/dome/dome_script.cpp.ORIGINAL || exit 1
diff -q ~/ha/setup_indi/weatherwatcher.cpp.ORIGINAL ~/indi/libindi/drivers/weather/weatherwatcher.cpp.ORIGINAL || exit 1
